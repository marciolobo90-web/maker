...
export const BRACELET_COLORS: BraceletColor[] = [
  { name: "Branco", hex: "#FFFFFF", textColor: "#000000" },           // Process White
  { name: "Azul Royal", hex: "#003DA5", textColor: "#FFFFFF" },       // Pantone 2935C
  { name: "Azul Claro", hex: "#00A3E0", textColor: "#FFFFFF" },       // Pantone 299C
  { name: "Azul Marinho", hex: "#00205B", textColor: "#FFFFFF" },     // Pantone 281C
  { name: "Vinho", hex: "#9B2335", textColor: "#FFFFFF" },            // Pantone 201C
  { name: "Laranja", hex: "#FE5000", textColor: "#FFFFFF" },          // Pantone 021C
  { name: "Preto", hex: "#000000", textColor: "#FFFFFF" },            // Process Black
  { name: "Roxo", hex: "#582C83", textColor: "#FFFFFF" },             // Pantone 268C
  { name: "Lilás", hex: "#7B61A4", textColor: "#FFFFFF" },            // Pantone 265C
  { name: "Marrom", hex: "#6C4B2A", textColor: "#FFFFFF" },           // Pantone 476C
  { name: "Amarelo", hex: "#FEDD00", textColor: "#000000" },          // Pantone 116C
  { name: "Verde Limão", hex: "#44D62C", textColor: "#000000" },      // Pantone 802C
  { name: "Verde Água", hex: "#00B388", textColor: "#FFFFFF" },       // Pantone 326C
  { name: "Vermelho", hex: "#E4002B", textColor: "#FFFFFF" },         // Pantone 185C
  { name: "Rosa Claro", hex: "#F99FC9", textColor: "#000000" },       // Pantone 210C
  { name: "Rosa Médio", hex: "#E0457B", textColor: "#FFFFFF" },       // Pantone 224C
  { name: "Pink", hex: "#E6007E", textColor: "#FFFFFF" },             // Pantone 806C
  { name: "Colorido", hex: "#E6007E", textColor: "#FFFFFF" },         // 806C+299C+115C (multi)
  { name: "Mesclado Azul", hex: "#003DA5", textColor: "#FFFFFF" },    // Reflex Blue+299C
  { name: "Mesclado Rosa", hex: "#E6007E", textColor: "#FFFFFF" },    // 806C+210C
];
...
// viewBox original: 0 0 21000 29700 - os paths estão nesse espaço de coordenadas
...
export const BRACELET_SYMBOLS: BraceletSymbol[] = [
  ...
  },
  {
    ...
    paths: [
      ...
      {
        d: "M10959.35 14679.44c9.59,-0.42 18.21,3.31 24.69,9.51 3.56,3.42 6.5,7.61 8.59,12.26 2.12,4.71 3.4,9.88 3.64,15.2 0.49,11.17 -3.55,23.32 -13.81,34.03 -0.91,0.96 -1.92,1.87 -2.96,2.72 -6.7,5.42 -15.66,8.37 -24.54,8.43 -8.66,0.06 -17.19,-2.65 -23.3,-8.51 -0.8,-0.74 -1.58,-1.61 -2.36,-2.56l-8.74 -10.77 -5.45 12.75 -6.13 15.13c-4.72,11.83 -9.91,24.81 -14.61,33.28 -2.96,5.32 -6.34,8.5 -10.23,9.58 -4.21,1.18 -9.69,0.26 -16.55,-2.67l-52.09 -22.26c-3.3,-1.41 -4.96,-2.5 -5.33,-3.37 -0.22,-0.53 0.16,-1.82 0.96,-3.69 0.22,-0.52 2.45,-1.49 